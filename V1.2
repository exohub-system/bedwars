...
win.BorderSizePixel=0; win.ClipsDescendants=false; win.Active=true; win.Draggable=true
win.Parent=SG
...
-- v1.1 label
local verLbl=Instance.new("TextLabel",topBarF); verLbl.Size=UDim2.new(0,40,1,0)
verLbl.Position=UDim2.new(1,-100,0,0); verLbl.BackgroundTransparency=1
verLbl.Text="v1.2"; verLbl.Font=Enum.Font.GothamBold; verLbl.TextSize=9
verLbl.TextColor3=T.SubText; verLbl.ZIndex=9

local function mkBtn(txt,col,xOff)
    local b=Instance.new("TextButton",topBarF); b.Size=UDim2.new(0,22,0,22)
    b.Position=UDim2.new(1,xOff,0.5,-11); b.BackgroundColor3=col; b.Text=txt
    b.TextColor3=Color3.fromRGB(255,255,255); b.Font=Enum.Font.GothamBlack; b.TextSize=12
    b.BorderSizePixel=0; b.ZIndex=10; Instance.new("UICorner",b).CornerRadius=UDim.new(0,6)
    return b
end
local closeBtn=mkBtn("×",Color3.fromRGB(190,40,55),-24)
local miniBtn=mkBtn("─",Color3.fromRGB(18,22,40),-50)
...
local function makeTab(cfg)
    ...
    scroll.ScrollBarImageColor3=T.Accent; scroll.CanvasSize=UDim2.new(0,0,2,0)
    ...
    local function mkRow(h)
        ...
        row.BackgroundColor3=T.RowBg; row.BorderSizePixel=0; row.ZIndex=10; row.LayoutOrder=rowN
